...
import static com.github.qlefevre.eclipse.mat.easy.inspections.CollectionImplementations.ORG_APACHE_COMMONS_COLLECTIONS_MAP_LRUMAP;
import static com.github.qlefevre.eclipse.mat.easy.inspections.CollectionImplementations.ORG_APACHE_COMMONS_COLLECTIONS_MAP_REFERENCEIDENTITYMAP;
import static com.github.qlefevre.eclipse.mat.easy.inspections.CollectionImplementations.ORG_APACHE_COMMONS_COLLECTIONS_MAP_STATICBUCKETMAP;
...
public class ApacheCommonsCollectionsMapHeapResolverImpl extends AbstractCollectionHeapResolver
	...
	public int getCollectionSize(IObject object) throws SnapshotException {
		...
		IObject delegateMap = (IObject) object.resolveValue("delegateMap");
		Integer resolvedSize;
		if (delegateMap == null) {
			resolvedSize = (Integer) object.resolveValue("size");
		} else {
			resolvedSize = (Integer) delegateMap.resolveValue("size");
		}
